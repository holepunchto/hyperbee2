...
test('fuzz regression #1', async function (t) {
  ...
  const keys = [
    '1091', '1155', '1192', '1627', '1700', '1738', '1778', '2040',
    '2284', '2295', '2376', '2464', '2554', '2601', '2609', '2994',
    '3316', '3334', '3625', '4012', '402', '4022', '4048', '4234',
    '427', '4297', '4456', '4480', '460', '4609', '5376', '5523',
    '5586', '5725', '5845', '605', '6294', '6320', '6506', '6531',
    '6629', '6929', '7037', '7501', '7554', '7742', '8196', '8323',
    '8542', '8677', '8753', '8804', '8811', '8826', '8895', '8935',
    '9068', '9422', '9513', '967', '9866', '9889'
  ].map(x => b4a.from(x))

  const expected = [
    '4609', '5376', '5523', '5586', '5725', '5845', '605', '6294',
    '6320', '6506', '6531'
  ]
...
test('fuzz regression #2', async function (t) {
  ...
  const keys = [
    '1493', '1581', '1602', '2', '2453', '2610', '2685', '2738',
    '2744', '2998', '3290', '3593', '3710', '3786', '3879', '3890',
    '3914', '3971', '4425', '4453', '4577', '460', '4728', '49',
    '5011', '502', '5329', '5394', '5987', '6233', '6525', '6817',
    '6851', '7059', '7426', '7493', '7663', '7670', '7742', '806',
    '8203', '8207', '8413', '8640', '9201', '933', '9330', '9365',
    '9745', '9942'
  ].map(x => b4a.from(x))

  const expected = [
    '2685', '2610', '2453', '2', '1602', '1581', '1493'
  ]
...
test('fuzz regression #3', async function (t) {
  ...
  const keys = [
    '1355', '1414', '1634', '1673', '1782', '1857', '2023', '2189',
    '2192', '2481', '2582', '2705', '2732', '2985', '313', '3300',
    '3514', '3532', '3611', '3650', '3769', '3881', '3964', '4048',
    '408', '4127', '4281', '4472', '4757', '484', '5095', '5332',
    '5483', '5547', '5859', '5877', '599', '6138', '6271', '6464',
    '6732', '6812', '6897', '6943', '703', '723', '7335', '7454',
    '7459', '7534', '772', '7886', '8184', '8747', '8762', '8782',
    '8924', '904', '9542', '9647', '9677', '9770', '9790', '9881',
    '9922', '9998'
  ].map(x => b4a.from(x))
...
test('random fuzz (2k rounds)', async function (t) {
  ...
  for (let i = 0; i < 10; i++) {
    ...
    for (const s of sorted) {
      ...
      if ((opts.gte ? a <= 0 : opts.gt ? a < 0 : true) && (opts.lte ? b <= 0 : opts.lt ? b < 0 : true)) {
        expected.push(s)
      }
    }
